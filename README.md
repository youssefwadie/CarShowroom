...
| Dependency         | `maven` is used to install the JDBC driver and the JPA implementation. Here we're using [Mysql Connector](https://mvnrepository.com/artifact/mysql/mysql-connector-java/8.0.29) and [eclipselink](https://www.eclipse.org/eclipselink/) as a JPA implementation ![maven dependencies](/images/installation/maven-dep.png) |
